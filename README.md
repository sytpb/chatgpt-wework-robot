...
1. 创建企业微信应用
操作方法：第一步，企微管理员， 电脑端上的企业微信-->头像-->管理企业-->应用管理-->（最下面）创建应用-->应用logo + 填入基本信息

![image](https://user-images.githubusercontent.com/12178686/233253332-f7ec7888-d9b8-4c06-aec8-ff38a0cb9b73.png)
