...
1. 如果没有特别要求，建议优先选择钉钉的一键部署，因为钉钉相对容易。 <br/>
2. 如果一键部署企业微信遇到问题，又不想购买独立服务器，请选择钉钉的一键部署。<br/>
...
2、可信IP无法配置 <br/>
解决办法：提示不允许第三方IP, 要求公司自己的服务器的，遇此问题的, 办法一是购买自己的服务器，将服务配置到服务器上，办法二是选择钉钉一键部署，钉钉没有此限制。
